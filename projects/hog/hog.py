...
def roll_dice(num_rolls, dice=six_sided):
    ...
    for dice in all_dices:
        ...
        if dice == 1:
            sow_sad = True
    return 1 if sow_sad == True else cnt
    # END PROBLEM 1
...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    tens_digit_opponent, ones_digit_current = ( opponent_score // 10 ) % 10, \
                                                player_score % 10
    return max(1, 3 * abs(tens_digit_opponent - ones_digit_current))
    # END PROBLEM 2
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    return sus_points(player_score + turn_score)
    # END PROBLEM 4
...
def play(strategy0, strategy1, update,
    ...
    while score0 < goal and score1 < goal:
        roll_num_0, roll_num_1 = strategy0(score0, score1), \
                                 strategy1(score1, score0)
        if who == 0:
            score0 = update(roll_num_0, score0, score1, dice)
        elif who == 1:
            score1 = update(roll_num_1, score1, score0, dice)
        who = 1 - who
    # END PROBLEM 5
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def strategy_n(player_score, opponent_score):
        return n
    return strategy_n
    # END PROBLEM 6
...
def is_always_roll(strategy, goal=GOAL):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    roll_num = strategy(1, 1)
    for i in range(1, goal + 1):
        for j in range(1, goal + 1):
            if roll_num != strategy(i, j):
                return False
    return True
    # END PROBLEM 7
...
def make_averaged(original_function, times_called=1000):
    ...
    def average_function(*args):
        ave_val, cnt = 0, 0
        for k in range(times_called):
            cnt += original_function(*args)
        ave_val = cnt / times_called
        return ave_val
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    max_roll, max_ave = 1, 0
    for i in range(1, 11):
        cur_ave = averaged_dice(i, dice)
        if cur_ave > max_ave:
            max_roll = i
            max_ave = cur_ave
    return max_roll
